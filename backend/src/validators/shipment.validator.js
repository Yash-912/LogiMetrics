...
/**
 * Validation rules for bulk creating shipments
 */
const bulkCreateValidation = [
  body()
    .isArray({ min: 1 })
    .withMessage('Request body must be an array of shipment objects'),
...
module.exports = {
  ...
  cancelShipment: getShipmentValidation, // Cancellation usually just needs ID check
  deleteShipment: deleteShipmentValidation,
  bulkCreate: bulkCreateValidation,
