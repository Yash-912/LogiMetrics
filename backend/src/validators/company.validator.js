...
/**
 * Validation rules for removing team member
 */
...
module.exports = {
  ...
  updateCompanySettings: updateSettingsValidation, // In case controller name matches
  updateSubscription: updateSubscriptionValidation,
  deleteCompany: deleteCompanyValidation,
  addTeamMember: teamMemberValidation,
  removeTeamMember: removeTeamMemberValidation,
  updateMemberRole: updateMemberRoleValidation,
  uploadLogo: uploadLogoValidation,
  getStats: getStatsValidation,
  getSubscription: getCompanyValidation // Subscription usually uses ID check
};
