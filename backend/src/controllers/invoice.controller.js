...
const { Invoice, Shipment, Company, Transaction } = require("../models/mongodb");
...
const getInvoiceById = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Invoice retrieved successfully", 200, { invoice });
  } catch (err) {
    next(err);
  }
};
...
const createInvoice = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Invoice created successfully", 201, {
...
const updateInvoice = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Invoice updated successfully", 200, {
...
const deleteInvoice = async (req, res, next) => {
  try {
    ...
    await Shipment.update({ invoiceId: null }, { where: { invoiceId: id } });
...
const updateInvoiceStatus = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Invoice status updated successfully", 200, { status });
  } catch (err) {
    next(err);
  }
};
...
const sendInvoice = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Invoice sent successfully", 200, { sentTo: emailTo });
  } catch (err) {
    next(err);
  }
};
...
const markAsViewed = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Invoice marked as viewed", 200);
  } catch (err) {
    next(err);
  }
};
...
const addLineItem = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Line item added successfully", 200, {
      lineItem: newItem,
...
const removeLineItem = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Line item removed successfully", 200, {
      invoice: await Invoice.findByPk(id),
    });
  } catch (err) {
    next(err);
...
const duplicateInvoice = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Invoice duplicated successfully", 201, {
      invoice: newInvoice,
    });
  } catch (err) {
    next(err);
...
const generateFromShipments = async (req, res, next) => {
  try {
    ...
    logger.info(
      `Invoice generated: ${invoiceNumber} from ${shipments.length} shipments`
    );

    return successResponse(res, "Invoice generated successfully", 201, { invoice });
  } catch (err) {
    next(err);
  }
};
