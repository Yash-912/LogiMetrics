      ...
      include: [
        {
          model: Subscription,
          as: "subscription",
          attributes: ["id", "plan", "status", "expiresAt"],
        },
      ],
...
const getCompanyById = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Company retrieved successfully", 200, {
      company,
    });
  } catch (err) {
    next(err);
...
const createCompany = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Company created successfully", 201, {
      company,
    });
  } catch (err) {
    next(err);
...
const updateCompany = async (req, res, next) => {
  try {
    ...
    if (
      ...
      updateData.registrationNumber !== company.registrationNumber
    ) {
      const existingCompany = await Company.findOne({
    ...
    return successResponse(res, "Company updated successfully", 200, {
...
const updateCompanySettings = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Company settings updated successfully", 200, {
      settings: company.settings,
      timezone: company.timezone,
      currency: company.currency,
    });
...
const uploadLogo = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Company logo uploaded successfully", 200, {
      logoUrl,
    });
  } catch (err) {
    next(err);
...
const getSubscription = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Subscription retrieved successfully", 200, {
...
const updateSubscription = async (req, res, next) => {
  try {
    ...
    if (!company.subscription) {
      ...
      return successResponse(res, "Subscription created successfully", 201, {
        subscription,
      });
    }
    ...
    return successResponse(res, "Subscription updated successfully", 200, {
      subscription: company.subscription,
    });
  } catch (err) {
    next(err);
...
const addTeamMember = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Team member added successfully", 200, {
      member: user,
    });
  } catch (err) {
    next(err);
...
const removeTeamMember = async (req, res, next) => {
  try {
    ...
    logger.info(
      `Team member removed: ${user.email} from company ${company.name}`
    );
...
const updateMemberRole = async (req, res, next) => {
  try {
    ...
    return successResponse(res, "Member role updated successfully", 200, {
      userId,
