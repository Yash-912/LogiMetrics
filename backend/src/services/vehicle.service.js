...
async function createVehicle(vehicleData, createdBy) {
  ...
  // Log the action
  await logVehicleAction(createdBy, "create", vehicle.id, {
    registrationNumber,
  });
...
async function updateVehicle(vehicleId, updateData, updatedBy) {
  ...
  // Log the action
  await logVehicleAction(updatedBy, "update", vehicleId, {
...
async function updateVehicleStatus(vehicleId, status, notes, updatedBy) {
  ...
  // Log the action
  await logVehicleAction(updatedBy, "status_change", vehicleId, {
    status,
    notes,
  });
...
async function unassignDriver(vehicleId, unassignedBy) {
  ...
  // Log the action
  await logVehicleAction(unassignedBy, "unassign_driver", vehicleId, {
    driverId,
  });
...
async function addMaintenanceRecord(vehicleId, recordData, createdBy) {
  ...
  // Log the action
  await logVehicleAction(createdBy, "add_maintenance", vehicleId, {
...
async function updateMaintenanceRecord(
  ...
  // Log the action
  await logVehicleAction(updatedBy, "update_maintenance", vehicleId, {
...
async function addFuelLog(vehicleId, logData, createdBy) {
  ...
  // Log the action
  await logVehicleAction(createdBy, "add_fuel_log", vehicleId, {
    fuelLogId: log.id,
  });
