...
vehicleTelemetrySchema.index(
  { timestamp: 1 },
  { expireAfterSeconds: 90 * 24 * 60 * 60 }
);

// Static methods
vehicleTelemetrySchema.statics.getLatestTelemetry = async function (
  vehicleId,
  telemetryType
) {
...
vehicleTelemetrySchema.statics.getTelemetryHistory = async function (
  vehicleId,
  telemetryType,
  startTime,
  endTime
...
vehicleTelemetrySchema.statics.getAlerts = async function (
  vehicleId,
  limit = 50
) {
...
vehicleTelemetrySchema.statics.getFuelHistory = async function (
  vehicleId,
  days = 7
) {
